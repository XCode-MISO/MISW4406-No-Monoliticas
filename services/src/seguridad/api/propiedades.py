...
from seguridad.modulos.propiedades.aplicacion.mapeadores import MapeadorPropiedadDTOJson
from seguridad.modulos.propiedades.aplicacion.servicios import ServicioPropiedad
from seguridad.modulos.propiedades.aplicacion.queries.obtener_propiedad import ObtenerPropiedad
from seguridad.modulos.propiedades.aplicacion.comandos.crear_propiedad import CrearPropiedad
...
from seguridad.modulos.propiedades.infraestructura.despachadores import Despachador
...
def agregar_propiedad():
    ...
    try:
        propiedad_dict = request.json
        print('---------------> propiedad_dict: ', propiedad_dict)
        map_propiedad = MapeadorPropiedadDTOJson()
        print('---------------> map_propiedad: ', map_propiedad)
        propiedad_dto = map_propiedad.externo_a_dto(propiedad_dict)
