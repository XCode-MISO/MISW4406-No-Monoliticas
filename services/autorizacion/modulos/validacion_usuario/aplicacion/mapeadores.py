...
class MapeadorValidacion_UsuarioDTOJson(AppMap):
    def externo_a_dto(self, externo: dict) -> Validacion_UsuarioDTO:
        validacion_usuario_dto = Validacion_UsuarioDTO(externo.get('fecha_validacion'),externo.get('fecha_actualizacion'),externo.get('usuario'),externo.get('nombre'), externo.get('imagen'), externo.get('fecha_fin'))
