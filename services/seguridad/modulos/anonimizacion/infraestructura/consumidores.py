...
def suscribirse_a_eventos():
    ...
    try:
        ...
        consumidor = cliente.subscribe('public/default/eventos-anonimizacion-finalizada', consumer_type=_pulsar.ConsumerType.Shared,
                                       subscription_name='seguridad-sub-eventos', schema=AvroSchema(AnonimizacionAgregada))
