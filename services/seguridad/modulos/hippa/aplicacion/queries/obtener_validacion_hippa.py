...
class ObtenerValidacionHippaHandler(ValidacionHippaQueryBaseHandler):
    ...
    def handle(self, query: ObtenerValidacionHippa) -> QueryResultado:
        ...
        validacion_hippa =  self.fabrica_validacion_hippa.crear_objeto(repositorio.obtener_por_id(query.id), MapeadorValidacionHippa())
...
def ejecutar_query_obtener_validacion_hippa(query: ObtenerValidacionHippa):
    handler = ObtenerValidacionHippaHandler()
