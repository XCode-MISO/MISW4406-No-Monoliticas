...
from seguridad.modulos.anonimizacion.dominio.objetos_valor import NombreAero, Odo, Leg, Segmento, Itinerario, CodigoIATA
from seguridad.modulos.anonimizacion.dominio.entidades import Proveedor, Aeropuerto, Reserva
